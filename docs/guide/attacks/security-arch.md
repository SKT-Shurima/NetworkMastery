---
title: 网络安全架构
description: 介绍纵深防御、多层防线与网络安全架构设计要点。
---
...
graph TB
    subgraph "纵深防御模型"
        A["[earth] 物理安全<br/>机房门禁 / 监控"]
        B["[net] 网络安全<br/>防火墙 / IDS/IPS"]
        C["[pc] 主机安全<br/>加固 / 补丁 / EDR"]
        D["[phone] 应用安全<br/>WAF / 代码审计"]
        E["[chart] 数据安全<br/>加密 / 备份 / DLP"]
        F["[user] 身份安全<br/>MFA / IAM / 零信任"]
    end
