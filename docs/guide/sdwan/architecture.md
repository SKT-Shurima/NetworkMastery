...
> <Icon name="clipboard-list" color="cyan" /> **前置知识**：[SD-WAN 概念与价值](/guide/sdwan/concepts)、[SDN 控制器架构](/guide/sdn/controllers)
> ⏱ **阅读时间**：约 15 分钟
...
## <Icon name="help-circle" color="purple" /> 开场思考：为什么需要"控制器"？
...
## <Icon name="layers" color="purple" /> 三平面分离架构
...
## <Icon name="sliders-horizontal" color="cyan" /> 核心组件详解
...
| 类型 | 使用场景 | 优缺点 |
|------|----------|--------|
| **物理设备** | 分支办公室 | <Icon name="check-circle-2" color="green" /> 性能高<br><Icon name="x-circle" color="danger" /> 成本高 |
| **虚拟机** | 数据中心 | <Icon name="check-circle-2" color="green" /> 灵活<br><Icon name="x-circle" color="danger" /> 性能中等 |
| **云原生** | 公有云 | <Icon name="check-circle-2" color="green" /> 弹性扩展<br><Icon name="x-circle" color="danger" /> 延迟稍高 |
...
3. 链路选择
   评估可用链路：
   - MPLS: 延迟 30ms, 带宽 10M, 利用率 40%  [v]
   - 宽带: 延迟 80ms, 带宽 100M, 利用率 20% [x] (延迟超标)
   → 选择 MPLS
...
## <Icon name="refresh-cw" color="cyan" /> 控制流与数据流
...
## <Icon name="ruler" color="cyan" /> 部署架构模式
...
## <Icon name="graduation-cap" color="magenta" /> 知识检查点
...
## <Icon name="rocket" color="magenta" /> 下一步
...
<div style="text-align: center; margin-top: 3rem; padding: 2rem; background: rgba(10, 14, 39, 0.9); border: 2px solid var(--neon-purple); border-radius: 12px;">
  <p style="font-family: var(--font-display); font-size: 1.2rem; color: var(--neon-purple); margin: 0;">
    <Icon name="lightbulb" color="cyan" /> 三平面分离是 SD-WAN 的核心设计哲学：决策者、执行者、管理者各司其职
  </p>
</div>
...
> <Icon name="book-open" color="cyan" /> **下一步学习**：[智能路由与流量优化](/guide/sdwan/routing) — 了解 SD-WAN 如何实现应用感知的动态路径选择
