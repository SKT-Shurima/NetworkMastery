...
> 📋 **前置知识**：[网络监控体系](/guide/ops/monitoring)、[意图驱动网络](/guide/emerging/intent-based-networking)
> ⏱️ **阅读时间**：约18分钟
...
graph TB
    ...
    subgraph 智能层["🧠 智能层（Intelligence Layer）"]
    ...
    subgraph 自动化层["⚙️ 自动化层（Automation Layer）"]
